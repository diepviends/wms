...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchContainer = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createAppStore = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default))(_redux.createStore);

	function configureStore() {
	    var store = createAppStore(_reducers2.default);
	    return store;
	};
	...
	function productReducer() {
	    ...
	    switch (action.type) {
	        case ActionTypes.RESPONSE_ERROR:
	            return Object.assign({}, state, { isLoading: false, products: action.data, error: true });
	        case ActionTypes.RESPONSE_DATA:
	            return Object.assign({}, state, { isLoading: false, products: action.data, error: false });
...
/***/ function(module, exports) {
	...
	var RESPONSE_DATA = exports.RESPONSE_DATA = 'RESPONSE_DATA';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchCondition = __webpack_require__(195);

	var _SearchCondition2 = _interopRequireDefault(_SearchCondition);

	var _SearchResult = __webpack_require__(196);
	...
	var searchAction = _interopRequireWildcard(_actions);
	...
	var SearchContainer = exports.SearchContainer = function (_Component) {
	    ...
	    _createClass(SearchContainer, [{
	        ...
	        value: function deleteProduct(code) {
	            ...
	            actions.deleteProduct(code, form);
	        }
	    }, {
	        key: 'searchProducts',
	        value: function searchProducts(event) {
	            event.preventDefault();
	            var actions = this.props.actions;
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_SearchCondition2.default, { onSearch: this.searchProducts, changeText: this.changeText, changeCategory: this.changeCategory }),
	                _react2.default.createElement(_SearchResult2.default, { products: searchResult.products, onDelete: this.deleteProduct })
	            );
	        }
	    }]);
	...
	SearchContainer.propTypes = {
	    ...
	    searchResult: _react.PropTypes.object
	};
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        actions: (0, _redux.bindActionCreators)(searchAction, dispatch)
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchCondition = function SearchCondition(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement("input", { type: "text", onChange: changeText })
	        ),
	        _react2.default.createElement(
	            "div",
	            null,
	...
	SearchCondition.propTypes = {
	    ...
	    changeText: _react.PropTypes.func,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.deleteProduct = exports.fetchData = undefined;
	...
	var URL = 'http://localhost:8080/ds-news/products/';
	...
	var responseData = function responseData(json) {
	    return {
	...
	var responseError = function responseError(json) {
	    return {
	...
	var fetchData = exports.fetchData = function fetchData(form) {
	    return function (dispatch) {
	        dispatch(requestData());
	        return _axios2.default.post(URL, form).then(function (response) {
	            return dispatch(responseData(response.data));
	        }).catch(function (response) {
	            return dispatch(responseError(response.data));
	        });
	    };
	};

	var deleteProduct = exports.deleteProduct = function deleteProduct(code, form) {
	    return function (dispatch) {
	        dispatch(deleteData());
	        return _axios2.default.delete(URL + code).then(dispatch(fetchData(form)));
	    };
	};
